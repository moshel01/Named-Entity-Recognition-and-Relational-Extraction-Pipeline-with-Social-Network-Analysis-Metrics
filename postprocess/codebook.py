...
_NODE_DEFS: dict[str, str] = {
    ...
    "tag_citation_artifact": "True for publishers, archives, and bibliographic author-name forms lifted from reference lists; kept for filtering, not a network actor.",
...
_EDGE_DEFS: dict[str, str] = {
    ...
    "cooccur_strength": "Co-occurrence edges only: Newman one-mode projection weight (a pair sharing a k-entity document contributes 1/(k-1)). Higher = co-mentioned in smaller, more specific contexts.",
    "disparity_alpha": "Co-occurrence edges only: disparity-filter significance (Serrano 2009). Lower = a stronger-than-random tie for at least one endpoint; filter to a small alpha for the weighted backbone.",
