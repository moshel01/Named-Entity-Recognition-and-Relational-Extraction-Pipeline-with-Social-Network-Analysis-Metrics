...
RELATION_GUIDE: dict[str, str] = {
    ...
    "led": "Headed or directed an organization or group (non-military). Use commanded for troops. The subject is the leader, the object what they head; 'under the leadership of X, the unit...' means X led the unit, not the reverse. Holding a lesser post (cashier, clerk) in a unit is not leading it.",
    ...
    "supported": "Backed, endorsed, or aided - without a formal alliance (allied_with) or propaganda (propagandized_for). Requires an active act of backing. Merely hearing of, learning about, admiring, or benefiting from someone is not support.",
    ...
    "met_with": "A specific face-to-face meeting or direct two-way encounter between people. Hearing someone speak, attending their rally, or being in the same town or event is not met_with.",
    ...
    "located_in": "A person or org is situated in a place (home, seat, base). The subject itself must be there - not merely associated with a place named in passing (people or goods 'from' somewhere are not located there).",
